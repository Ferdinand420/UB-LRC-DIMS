...
('Discussion Room A', 6, 'available', 'Small group study room with whiteboard and projector'),
('Discussion Room B', 10, 'available', 'Medium-sized room suitable for team meetings'),
('Discussion Room C', 4, 'available', 'Quiet room perfect for small study groups'),
('Discussion Room D', 8, 'available', 'Conference-style room with presentation equipment'),
('Discussion Room E', 12, 'available', 'Large collaborative space with flexible seating'),
('Study Pod 1', 2, 'available', 'Individual study pod for focused work'),
('Study Pod 2', 2, 'maintenance', 'Currently under maintenance - AC repair');
...
(3, 4, '2025-11-28', '10:00:00', '12:00:00', 'Thesis consultation meeting', 'approved', 6, '2025-11-26 12:00:00'),
(4, 3, '2025-11-28', '14:00:00', '16:00:00', 'Review session for Midterm exams', 'approved', 7, '2025-11-26 13:00:00'),
(5, 5, '2025-11-29', '08:00:00', '10:00:00', 'Club meeting - Computer Society', 'approved', 7, '2025-11-26 14:00:00'),
...
(3, 3, '2025-12-01', '10:00:00', '12:00:00', 'Research group meeting', 'pending', NULL, NULL),
(4, 4, '2025-12-01', '14:00:00', '16:00:00', 'Capstone project discussion', 'pending', NULL, NULL),
(5, 5, '2025-12-02', '09:00:00', '11:00:00', 'Study session for Finals', 'pending', NULL, NULL),
-- Past reservations
(1, 1, '2025-11-20', '09:00:00', '11:00:00', 'Quiz review session', 'approved', 6, '2025-11-19 15:00:00'),
(2, 3, '2025-11-22', '13:00:00', '15:00:00', 'Group assignment work', 'approved', 6, '2025-11-21 10:00:00'),
(3, 2, '2025-11-23', '10:00:00', '12:00:00', 'Lab report collaboration', 'approved', 7, '2025-11-22 14:00:00'),
...
(2, 'Could we have more power outlets in Room B? Sometimes we run out when everyone brings laptops.', 'reviewed'),
(3, 'The air conditioning in Room E is too cold. Can it be adjusted?', 'new'),
(4, 'Suggestion: Add a booking calendar display at the entrance so students can see availability.', 'new'),
(5, 'The whiteboard markers in Room C need replacement. They are almost dried out.', 'reviewed'),
...
(1, 3, 6, 'Noise complaint from adjacent room. Students reminded about noise policy.');
...
(3, 4, '2025-11-29', '14:00:00', 'waiting');
