...
<div class="site-topbar">
  <div class="topbar-inner">
    <div class="brand"><a href="<?= $base ?>index.php" class="brand-link" aria-label="UB LRC-DIMS Home"><img src="<?= $base ?>assets/media/DIMS_logo.png" alt="DIMS Logo" class="brand-logo" height="40" width="40"> UB LRC-DIMS</a></div>
    <div class="actions">
      <?php if (get_role()): ?>
